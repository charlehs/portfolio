    ...
    <div className="px-4 py-6 flex flex-col justify-between h-screen ">
      <main className=" flex flex-col h-[75%] justify-between">
        ...
        <div className="grid grid-cols-3  text-xs max-w-[50%] gap-6">
          <p>
            Currently, I lead creative and technical efforts as Web Developer &
            Designer at RevEng.ai, where I designed our brand identity,
            developed a sleek web app dashboard with React and Next.js, and
            crafted a cohesive user experience with Tailwind CSS. Previously, I
            was a Designer at Playground XYZ, where I established brand
            guidelines, rebuilt the company website in Webflow, and shaped the
            creative direction for core products. My career also includes time
            at Cyclr, building API connectors, and The Cheeky Panda, where I
