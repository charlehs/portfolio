      ...
      <main className=" flex flex-col h-[75%] justify-between">
        ...
        <div className="grid grid-cols-3  text-xs max-w-[50%] gap-6">
          <p>
            ...
            the creative direction for core products. My career also includes
            time at Cyclr, building API connectors, and The Cheeky Panda, where
            I combined design and marketing expertise to drive product success
